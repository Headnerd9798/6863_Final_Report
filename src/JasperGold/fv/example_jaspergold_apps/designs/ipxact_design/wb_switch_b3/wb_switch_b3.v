...
`endif
   ...
   wire 			  wbm0_req;
   assign wbm0_req = (wbm0_adr_o[(aw-(slave_sel_bit_width)):aw-1] ==  slave_addr) &
		     wbm0_cyc_o;
`ifdef WBM1
   wire 			  wbm1_req;
   assign wbm1_req = (wbm1_adr_o[(aw-(slave_sel_bit_width)):aw-1] ==  slave_addr) &
		     wbm1_cyc_o;
`endif
   
`ifdef WBM2
   wire 			  wbm2_req;
   assign wbm2_req = (wbm2_adr_o[(aw-(slave_sel_bit_width)):aw-1] ==  slave_addr) &
		     wbm2_cyc_o;
`endif

`ifdef WBM3
   wire 			  wbm3_req;
   assign wbm3_req = (wbm3_adr_o[(aw-(slave_sel_bit_width)):aw-1] ==  slave_addr) &
		     wbm3_cyc_o;
`endif
`ifdef WBM4
   wire 			  wbm4_req;
   assign wbm4_req = (wbm4_adr_o[(aw-(slave_sel_bit_width)):aw-1] ==  slave_addr) &
		     wbm4_cyc_o;
`endif
`ifdef WBM5
   wire 			  wbm5_req;
   assign wbm5_req = (wbm5_adr_o[(aw-(slave_sel_bit_width)):aw-1] ==  slave_addr) &
		     wbm5_cyc_o;
`endif
